...
# DEMO:./concat.sh -i ./ -e png -o ./ -f jahreswechsel_stuttgart.png -r 202
#
...
#magick ../STUTTGART/2022*.jpg +append  null: -background none ‚\ $filename
magick montage null: $inputFolder$date_for_regexcomlete*.$extension null: -background none -background white -tile x1 -geometry +0+0  $outputFolder$filename
